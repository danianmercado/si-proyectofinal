...
@section('contenido')
    <div class="row">
        <div class="col s12 m10 offset-m1 l6 offset-l3">
            ...
            <form action="{{route('admin.detalle_servicio.delete',[$servicio->id,$detalle->id])}}" method="post">
                @csrf
                @method('delete')
                <div class="card z-depth-4">
                    <div class="card-content">
                        <span class="card-title center-align">Eliminar Detalle de Servicio </span>
